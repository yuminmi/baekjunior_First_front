...
<body>
	...
	<div
		...
		<button onclick="location.href='#'"
			style="border-right: 3px solid black; font-size: 15px; font-weight: bold; width: 60px;">Switch
			Sides</button>
	</div>

	<div style="display: grid; grid-template-columns: 1fr 1fr;">
		<div style="margin-top: 20px; border-right: 3px solid black;">
			<div style="width: 80%; margin: 0 auto;">
				<div style="float: right;">
					<button onclick="location.href='splitscreen2.jsp'"
						style="font-size: 15px; font-weight: bold; border: 3px solid black; padding: 0 5px;">X</button>
				</div>
				<br>
				<br>
				<div>
					<div>
						<div
							...
							#<span>15654</span> : <span>N과 M (5)</span> <span><img
								src="img/star_on.png" style="width: 18px;"></span>
						</div>
					...
					<div
						...
						<div style="display: inline; width: 80%;">
							...
							<span style="margin-right: 50px;">DFS</span> <span
								style="margin-right: 50px;">C++</span> Friends who solved : <span
								style="background: lightgray; font-size: 15px; padding: 3px 20px; border-radius: 20px;">Dodam</span>
							<span
								style="background: lightgray; font-size: 15px; padding: 3px 20px; border-radius: 20px;">Dam</span>
						</div>
						<div style="float: right; font-size: 15px; padding: 10px;">
							<a href="note_detail_edit.jsp" style="color: black;">Edit</a> <a
								href="#" style="color: black;">Delete</a>
						</div>
					</div>
				</div>
				...
				<div
					...
					<div style="padding: 5px;">
						<img src="img/star_red.png" style="width: 13px;"> <span>재귀함수를
							통해 문제를 풀이한다.</span>
					</div>
					<div style="padding: 5px;">
						<img src="img/star_red.png" style="width: 13px;"> <span>그리고
							안러 ㅣㄴㅇ러 ㅣ나얼 ㅣㅓ리아ㅓ라ㅣㅇ ㅣ아러ㅣ얼</span>
					</div>
				</div>

				<div
					style="display: grid; margin-top: 50px; grid-template-columns: 5fr 2fr; column-gap: 30px; font-size: 20px;">
					<div
						...
						<div id="code-editor"
							...
							<textarea class="notes" id="lineNumbers" rows="10" wrap="off"
								style="text-align: center; padding-bottom: 0px;" readonly></textarea>
							<textarea class="notes" id="cppCode" rows="10"
								placeholder="Enter your C++ code here..." wrap="off"
								style="overflow-x: auto; padding-bottom: 60px;" readonly>
...
int main() {
    ...
    cout << ans;
					...
					<div
						...
						<div id="code-editor" style="border: none;">
							<textarea class="notes" id="note_detail" rows="10"
								placeholder="Enter your C++ code here..." wrap="off"
								style="overflow-x: auto; padding-bottom: 60px;" readonly></textarea>
						</div>
					</div>
				</div>
		...
		<div style="margin-top: 20px; border-right: 3px solid black;">
			<div style="width: 80%; margin: 0 auto;">
				<div style="float: right;">
					<button onclick="location.href='splitscreen1.jsp'"
						style="font-size: 15px; font-weight: bold; border: 3px solid black; padding: 0 5px;">X</button>
				</div>
				<br>
				<br>
