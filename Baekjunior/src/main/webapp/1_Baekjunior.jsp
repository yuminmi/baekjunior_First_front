	...
	<div id="main">
		...
		<div id="main_bar">
			...
			<div id="btn_cretenote">
				<button onclick="location.href='create_note.jsp'">CREATE
					NOTE</button>
			</div>
		</div>
		...
		<div id="list_group">
 		...
 		%>
				<li class="item">
					<div class="content_number">
						<a
							href="note_detail.jsp?problem_idx=<%=rs.getInt("problem_idx")%>">#
							<%=rs.getInt("problem_id") %></a>
					</div>
					<div class="content_set">
						<img class="content_set_a" src="img/pin.png">
						<button class="content_set_b">
					...
					<div class="content_title">
						<a
							href="note_detail.jsp?problem_idx=<%=rs.getInt("problem_idx")%>"><%=rs.getString("memo_title") %></a>
					</div>
				</li>
				<%
 					con.close();
