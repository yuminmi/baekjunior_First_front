	...
	<form action="#" method="post">
		<div style="margin-top: 20px;">
			<div style="width: 80%; margin: 0 auto; border: 3px solid black;">
				<div
					style="font-size: 30px; font-weight: bold; padding: 40px; padding-left: 10px; padding-right: 10px; border-bottom: 3px solid black; background: #5F99EB">
					<img src="img/dot1.png"
						style="width: 15px; margin: 0 20px 0 40px; padding-bottom: 3px;">
				...
				<div style="padding: 30px;">
					<div id="note_info">
						...
						<input type="hidden" name="tier_name" id="tier_name"
							value="<%=tier_name%>"> <input type="hidden"
							name="tier_num" id="tier_num" value="<%=tier_num%>"> <input
							type="hidden" name="importCheck" id="importCheck" value="0">
						<div>
							Problem Number : <span style="border-bottom: 3px solid black;">
								<input type="text" id="problemId" name="problemId"
								value="<%=Util.nullChk(problemId, "") %>"
								oninput="resetImportCheck()"
								style="background: transparent; outline: none; border: none;">
							</span> <span><button type="button"
									style="font-size: 15px; font-weight: bold; padding: 5px 20px; background: white; border: 3px soild black;"
									onclick="importClick()">import</button> </span>
						</div>
						<div>
							Problem Title : <span style="border-bottom: 3px solid black;">
								<input type="text" id="title" name="title" value="<%=title%>"
								style="background: transparent; outline: none; border: none; width: 50%;">
							</span>
						</div>
						<div>
							Problem URL : <span style="border-bottom: 3px solid black;">
								<input type="text" id="problem_url" name="problem_url"
								value="<%=url%>"
								style="background: transparent; outline: none; border: none; width: 50%;">
							</span>
						</div>
						<div>
							...
							<div id="problem_category">
                                ...
                                %>
									<li><input type="checkbox" name="sorts" id="check_btn"
										value="unsorted" checked onclick="return false">
										unsorted</li>
									<%	
                                	} else {
                                ...
                                %>
									<li><input type="checkbox" name="sorts" id="check_btn"
										value="<%=algo%>" checked onclick="return false"> <%= algo %>
									</li>
									<%
                                        }
                                    }
					...
					<div id="note">
						<div style="margin-top: 20px;">
							Bookmark <input type="checkbox" name="check_btn" id="check_btn"
								value="1">
						</div>
						<div>Code</div>
						<div id="code-editor">
							<div id="lineNumbers"></div>
							<textarea id="cppCode" name="cppCode" rows="10"
		...
		<div style="width: 80%; margin: 0 auto; margin-top: 30px;">
			<div style="float: right;">
				<button type="submit"
					style="font-size: 15px; font-weight: bold; background: white; border: 3px solid black; padding: 5px 20px; margin-right: 10px;"
					onclick="return fnCheck('save_and_note')">Save and Note</button>
				<button type="submit"
					style="font-size: 15px; font-weight: bold; background: white; border: 3px solid black; padding: 5px 20px;"
