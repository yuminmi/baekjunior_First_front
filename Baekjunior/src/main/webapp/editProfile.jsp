...
<body>
	...
	<div class="contents">
		...
		<div class="inner_contents">
			<div class="myinfo">
				<form action="modify_profileImage.jsp?user_id=<%=userId %>"
					method="POST" enctype="multipart/form-data">
					<div class="img_box">
						<img src="./upload/<%=rs.getString("savedFileName") %>"
							class="profileimg" alt="profileimg"> <input type="file"
							accept="image/jpg,image/gif" name="fileName" class="imgUpload">
						<button type="submit" class="imgUpload">사진 업로드</button>
					</div>
				</form>
				<div class="info_box">
					<h1><%=rs.getString("user_id") %></h1>
					<form name="mytext" action="modify_intro.jsp?user_id=<%=userId %>"
						method="POST">
			...
			<div>
				<table>
					...
					<tr>
						<td><a href="#" onclick="confirmDeletion('<%=userId %>')">회원
								탈퇴 ></a></td>
					</tr>
				</table>
			</div>
