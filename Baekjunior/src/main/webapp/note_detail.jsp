			...
			<div>
				<div>
					<div
						...
						<span><img class="bookmark_star" src="img/star_on.png"
				...
				<div
					...
					<div style="display: inline; width: 80%;">
						<span><img src="img/dot1.png" style="width: 15px;"></span> <span
							style="margin-right: 50px;">DFS</span> <span
							style="margin-right: 50px;"><%=rs.getString("language") %></span>
						Friends who solved : <span
