...
<body>
	<div>
		...
		<div class="login_pg">
			...
			<div class="logbox">
				<form action="signup_do.jsp" method="POST" name="signupf"
					...
					<div>
						<label for="id">ID</label> <br> <input type="text" id="id"
							name="id" oninput="resetIdCheck()"> <input type="button"
							id="checkid" name="checkid" value="Duplicate check"
							onclick="checkID()">
					</div>
					<div>
					...
					<div>
						<label for="pw">PASSWORD CHECK</label> <br> <input
							type="password" id="pwConfirm" name="pwConfirm">
					</div>
					<div>
